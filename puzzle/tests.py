...
class ThumbnailTests(TestCase):
    def test_create_thumbnail(self):
        ...
        self.assertIn('rect y="0" x="0" width="10" height="10" style="fill:rgb(255,255,255);', svg)
        self.assertIn('rect y="0" x="10" width="10" height="10" style="fill:rgb(255,255,255);', svg)
        self.assertIn('rect y="0" x="20" width="10" height="10" style="fill:rgb(0,0,0);', svg)
        self.assertIn('rect y="10" x="0" width="10" height="10" style="fill:rgb(0,0,0);', svg)
        self.assertIn('rect y="10" x="10" width="10" height="10" style="fill:rgb(255,255,255);', svg)
        self.assertIn('rect y="10" x="20" width="10" height="10" style="fill:rgb(255,255,255);', svg)
        self.assertIn('rect y="20" x="0" width="10" height="10" style="fill:rgb(255,255,255);', svg)
        self.assertIn('rect y="20" x="10" width="10" height="10" style="fill:rgb(0,0,0);', svg)
        self.assertIn('rect y="20" x="20" width="10" height="10" style="fill:rgb(255,255,255);', svg)
